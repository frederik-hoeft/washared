...
namespace washared.DatabaseServer.ApiResponses
{
    public class SqlSingleOrDefaultResponse : ApiResponse
    {
        ...
        public SqlSingleOrDefaultResponse(SqlResponseId responseId, string result, bool success)
        {
...
#pragma warning disable CS0618 // Type or member is obsolete
            return new SqlSingleOrDefaultResponse(SqlResponseId.GetSingleOrDefault, result, !string.IsNullOrEmpty(result));
